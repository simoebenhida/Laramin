...
@section('styles')
		<link rel="stylesheet" type="text/css" href="{{ laramin_asset('css/ga-embed.css') }}">
@endsection
...
@section('scripts')
	@if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
		...
		<script src="{{ laramin_asset('js/ga-embed/chart.min.js') }}"></script>
		<script src="{{ laramin_asset('js/ga-embed/moment.min.js') }}"></script>
		<!-- Include the ViewSelector2 component script. -->
		<script src="{{ laramin_asset('js/ga-embed/view-selector2.js') }}"></script>
		<!-- Include the DateRangeSelector component script. -->
		<script src="{{ laramin_asset('js/ga-embed/date-range-selector.js') }}"></script>
		<!-- Include the ActiveUsers component script. -->
		<script src="{{ laramin_asset('js/ga-embed/active-users.js') }}"></script>
